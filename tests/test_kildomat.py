...
from src.notebooks.kildomat import process_observations
from src.notebooks.kildomat import process_weather_stations
...
def test_process_weather_stations(mocker: MockerFixture) -> None:
    ...
    mock_write_parquet_file = mocker.patch("src.notebooks.kildomat.write_parquet_file")
